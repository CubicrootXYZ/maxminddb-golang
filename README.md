...
[![Go Reference](https://pkg.go.dev/badge/github.com/CubicrootXYZ/maxminddb-golang.svg)](https://pkg.go.dev/github.com/CubicrootXYZ/maxminddb-golang)
...
```
go get github.com/CubicrootXYZ/maxminddb-golang
```
